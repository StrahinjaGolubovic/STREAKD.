// Achievement and notification icon components
// These replace emoji icons with SVG for better consistency and customization
...
export const HundredIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10" />
...
export const MedalIcon = ({ className = '', size = 24, variant = 'bronze' }: IconProps & { variant?: 'bronze' | 'silver' | 'gold' }) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const HandWaveIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SunriseIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v8" />
...
export const DumbbellIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const PartyIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M22 20h.01" />
        <circle cx="12" cy="12" r="2" />
        <path d="m13.4 10.6 7.08-7.08" />
        <path d="m3.52 20.48 7.08-7.08" />
    </svg>
);
...
export const IronStrengthIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v20" />
        <path d="M8 4h8" />
        <path d="M8 20h8" />
...
export const getAchievementIcon = (iconName: string, props?: IconProps) => {
    ...
    const iconMap: Record<string, React.FC<IconProps>> = {
        ...
        diamond: DiamondIcon,
        medal_bronze: (p) => <MedalIcon {...p} variant="bronze" />,
        medal_silver: (p) => <MedalIcon {...p} variant="silver" />,
        medal_gold: (p) => <MedalIcon {...p} variant="gold" />,
        coins: CoinsIcon,
        hand_wave: HandWaveIcon,
        users: UsersIcon,
