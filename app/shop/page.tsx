              ...
              <div className="relative flex flex-col md:flex-row items-center gap-6 sm:gap-8">
                ...
                <div className="flex-1 text-center md:text-left w-full md:w-auto">
                  <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-2 sm:gap-3 mb-3">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-primary-200 tracking-wider uppercase" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                      PREMIUM
                    </h3>
                  ...
                  <p className="text-gray-300 text-sm sm:text-base mb-4 leading-relaxed px-2 sm:px-0">
                    Unlock exclusive features, custom profile colors, special badges, and more premium perks!
                  </p>

                  {/* Features list */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-2 mb-4 px-2 sm:px-0">
                ...
                {/* Pricing & CTA */}
                <div className="flex-shrink-0 flex flex-col items-center gap-3 sm:gap-4 w-full md:w-auto">
                  {/* Price */}
                  <div className="text-center">
                    <div className="flex items-center gap-2 justify-center mb-1">
                      <span className="text-base sm:text-lg md:text-xl font-semibold text-gray-500 line-through">$5.00</span>
                  ...
                  <button
                    ...
                    className="relative group/btn w-full md:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary-500 to-primary-700 hover:from-primary-400 hover:to-primary-600 text-white font-black text-sm sm:text-base md:text-lg rounded-xl shadow-2xl hover:shadow-primary-500/50 transition-all duration-300 hover:scale-105 active:scale-95 border-2 border-primary-400/50"
