              ...
              <div className="relative flex flex-row items-center gap-3 sm:gap-6 md:gap-8">
                ...
                <div className="flex-shrink-0">
                  <div className="relative">
                    ...
                    <div className="relative w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-primary-500 to-primary-700 rounded-full flex items-center justify-center shadow-2xl border-2 sm:border-4 border-primary-400/30 group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-primary-100" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex-1 text-left min-w-0">
                  <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                    <h3 className="text-base sm:text-xl md:text-2xl lg:text-3xl font-black text-primary-200 tracking-wider uppercase truncate" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                      PREMIUM
                    </h3>
                    <span className="px-2 py-0.5 sm:px-3 sm:py-1 bg-primary-500/20 border border-primary-500/40 rounded-md text-[10px] sm:text-xs font-bold text-primary-300 uppercase tracking-wider whitespace-nowrap">
                      Coming Soon
                    </span>
                  </div>
                  <p className="text-gray-300 text-xs sm:text-sm md:text-base mb-2 sm:mb-4 leading-relaxed hidden sm:block">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 sm:gap-2 mb-2 sm:mb-4">
                    <div className="flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-sm text-gray-300">
                      <svg className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-primary-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <div className="flex-shrink-0 flex flex-col items-center gap-2 sm:gap-4">
                  ...
                  <div className="text-center">
                    <div className="flex items-center gap-1 sm:gap-2 justify-center mb-0.5 sm:mb-1">
                      <span className="text-xs sm:text-base md:text-lg lg:text-xl font-semibold text-gray-500 line-through">$5.00</span>
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-red-400" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M13.477 14.89A6 6 0 015.11 6.524l8.367 8.368zm1.414-1.414L6.524 5.11a6 6 0 018.367 8.367zM18 10a8 8 0 11-16 0 8 8 0 0116 0z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div className="flex items-baseline gap-0.5 sm:gap-1 justify-center">
                      <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-primary-200" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                        $2.50
                      </span>
                      <span className="text-[10px] sm:text-xs md:text-sm text-gray-400">/mo</span>
                    </div>
                    <div className="flex items-center gap-1 justify-center mt-0.5 sm:mt-1">
                      ...
                      <p className="text-[10px] sm:text-xs text-green-400 font-semibold">Save 50%</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="relative group/btn w-full px-3 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 bg-gradient-to-r from-primary-500 to-primary-700 hover:from-primary-400 hover:to-primary-600 text-white font-black text-[11px] sm:text-sm md:text-base lg:text-lg rounded-lg sm:rounded-xl shadow-2xl hover:shadow-primary-500/50 transition-all duration-300 hover:scale-105 active:scale-95 border border-primary-400/50 sm:border-2 whitespace-nowrap"
                  ...
                  >
                    <span className="relative z-10 flex items-center justify-center gap-1 sm:gap-2">
                      ...
                      <span className="hidden xs:inline sm:inline">GET PREMIUM</span>
