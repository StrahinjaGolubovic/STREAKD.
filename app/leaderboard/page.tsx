        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
          ...
          <div className="flex gap-2 mb-4 sm:mb-6 border-b border-gray-700 pb-4">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${activeTab === 'crews'
                  ? 'bg-primary-600 text-white'
                  : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                }`}
            >
                      ...
                      <div className="flex-shrink-0 w-10 flex items-center justify-center">
                        {user.rank <= 3 ? (
                          <span className="text-2xl">
                            {user.rank === 1 ? (
                              <svg className="w-6 h-6 text-yellow-400" fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><text x="12" y="16" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold">1</text></svg>
                            ) : user.rank === 2 ? (
                              <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><text x="12" y="16" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold">2</text></svg>
                            ) : (
                              <svg className="w-6 h-6 text-amber-600" fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><text x="12" y="16" textAnchor="middle" fontSize="10" fill="#000" fontWeight="bold">3</text></svg>
                            )}
                          </span>
                        ) : (
